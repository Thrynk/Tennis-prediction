...
df = pd.read_csv(os.path.abspath('../input/diff-cleaned-featured-2019.csv'))
...
df.to_csv(os.path.abspath('../input/standardized-diff-cleaned-featured-2019.csv'), index=False)