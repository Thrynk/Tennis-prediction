...
test_df = pd.read_csv(os.path.abspath('../input/cleaned-2019.csv'))
...
statistics_df_2018 = pd.read_csv(os.path.abspath('../input/cleaned-2018.csv'))

statistics_df_2007_2018 = pd.concat([statistics_df_2007_2017, statistics_df_2018])

statistics_df_2007_2018['datetime'] = statistics_df_2007_2018['date'].apply(lambda x: datetime.strptime(x, '%d/%m/%Y'))

frames = [statistics_df_2007_2018, test_df]
...
result_test_df.to_csv(os.path.abspath('../input/featured-2019.csv'), index=False)