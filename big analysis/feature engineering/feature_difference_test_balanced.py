...
test_df = pd.read_csv(os.path.abspath('../input/balanced-cleaned-featured-2018.csv'))
...
test_df.to_csv(os.path.abspath('../input/balanced-diff-cleaned-featured-2018.csv'), index=False)