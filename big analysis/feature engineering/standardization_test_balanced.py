...
df = pd.read_csv(os.path.abspath('../input/balanced-diff-cleaned-featured-2018.csv'))
...
df.to_csv(os.path.abspath('../input/balanced-standardized-diff-cleaned-featured-2018.csv'), index=False)
